...
void EmitAssemblyHelper::CreatePasses(legacy::PassManager &MPM,
  ...
  if (LangOpts.Sanitize.has(SanitizerKind::DVIPAC)) {
    PMBuilder.addExtension(PassManagerBuilder::EP_OptimizerLast, addDVIPACPass);
    PMBuilder.addExtension(PassManagerBuilder::EP_EnabledOnOptLevel0, addDVIPACPass);
  }
