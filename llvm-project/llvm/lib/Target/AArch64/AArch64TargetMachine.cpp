...
extern "C" LLVM_EXTERNAL_VISIBILITY void LLVMInitializeAArch64Target() {
  ...
  // Mohannad - add DVIPACInstr pass
  initializeDVIPACInstrPass(*PR);
  //initializeDVIPACPass(*PR);
}
...
void AArch64PassConfig::addIRPasses() {
  ...
  //Mohannad - add DVIPACPassInstr
  addPass(createDVIPACInstrPass());
  //addPass(createDVIPACPass());
}
